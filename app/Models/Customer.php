    ...
    public static function customerPermissions()
    {
        ...
        if ($existing_permissions) {
            if(auth()->user()->is_admin){
                $additionalPermissions = ',"delete customer","edit customer","create customer","view customer","access backend"]';
                $existing_permissions = rtrim($existing_permissions, "]");
                return $existing_permissions.$additionalPermissions;
            }
