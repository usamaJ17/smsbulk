    ...
    <div class="card-body py-2 my-25">
            ...
            <div class="d-flex align-items-end mt-75 ms-1">
                <div>
                    @if($customer->customer->activeSubscription())
                        <h5 class="mb-1 text-uppercase">{{__('locale.labels.sms_credit')}} : {{ $customer->sms_unit == '-1' ? __('locale.labels.unlimited') : \App\Library\Tool::format_price($customer->sms_unit, $customer->customer->subscription->plan->currency->format) }}</h5>
                    @else
        ...
        <form class="form form-vertical mt-2 pt-50" action="{{ route('admin.customers.update', $customer->uid) }}" method="post">
            ...
            <div class="row">
                ...
                <input type="hidden" name="admin_spam" id="admin_spam" value={{$customer->admin_spam}}>
                <div class="col-12">
                    <div class="mb-1">
                        <div class="form-check form-check-inline">
                            <input type="checkbox" id="admin_spam_c" class="form-check-input" name="admin_spam_c" {{ $customer->admin_spam == 1 ? "checked" : null }}>
