        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    ...
                    <h5 class="mb-1">{{ __('locale.labels.campaigns_type') }}: <span class="fw-bold"> {!! $campaign->getCampaignType() !!}</span></h5>
                    <h5 class="mb-1">{{ __('locale.labels.status') }}: <span class="fw-bold text-capitalize"> {{ $campaign->status }}</span></h5>
                    <h5 class="mb-1">{{ __('locale.labels.created_at') }}: <span class="fw-bold"> {{ \App\Library\Tool::customerDateTime($campaign->created_at) }}</span></h5>
                    <h5 class="mb-1">{{ __('locale.labels.run_at') }}: <span class="fw-bold"> {{ \App\Library\Tool::customerDateTime($campaign->run_at) }}</span></h5>
