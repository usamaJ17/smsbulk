        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @if(isset($menuData[0]))
                @php
                    ...
                    if (auth()->user()->is_customer == 1 && auth()->user()->is_reseller == 0 && auth()->user()->is_admin == 0){
                        $sidebarMenu = $menuData['0']->reseller_customer;
                    }
                @endphp
            ...
            @foreach($res_u as $it => $count)
<li class="nav-item">
    <a href="#" class="d-flex align-items-center">
        <button class="btn btn-sm btn-success mr-2"> 
            {{$it}}
        </button>&nbsp;&nbsp;
        <span class="menu-title text-truncate">{{$count}}</span>
    </a>
</li>
